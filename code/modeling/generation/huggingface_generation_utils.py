"""
A copy of transformers.generation_utils. See the added lines by searching '# added'.
"""
...
class GenerationMixin:
    ...
    def generate(
            ...
            # added
            additional_logits_processors: Optional[Union[LogitsProcessorList, LogitsProcessor, LogitsWarper]] = None,
            **model_kwargs,
        ...
        # added
        if additional_logits_processors is not None:
            if isinstance(additional_logits_processors, list):
                logits_processor.extend(additional_logits_processors)
            elif isinstance(additional_logits_processors, (LogitsWarper, LogitsProcessor)):
                logits_processor.append(additional_logits_processors)
            else:
                raise ValueError(
                    f"additional_logits_processors has to be an instance of: LogitsWarper,"
                    f" LogitsProcessor or LogitsProcessorList."
                )
